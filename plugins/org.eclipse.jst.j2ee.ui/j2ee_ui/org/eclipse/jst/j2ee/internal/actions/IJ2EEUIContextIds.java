...
public interface IJ2EEUIContextIds {
	...
	public static final String NEW_JAVA_CLASS_OPTION_WIZARD_PAGE = J2EEUIPlugin.PLUGIN_ID + ".NEW_JAVA_CLASS_OPTION_WIZARD_PAGE"; //$NON-NLS-1$
	...
	public static final String REFERENCE_WIZARD_P8 = J2EEUIPlugin.PLUGIN_ID + ".REFERENCE_WIZARD_PAGE8"; //$NON-NLS-1$

	public static final String EDIT_MES_DEST_LINK_WIZARD_P1 = J2EEUIPlugin.PLUGIN_ID + ".EDIT_MES_DEST_LINK_WIZARD_P1"; //$NON-NLS-1$
	...
	//Add Module, Utility jar
	public static final String ADD_MODULE_WIZARD = J2EEUIPlugin.PLUGIN_ID + ".EAR_ADDMODULEWIZARD_PAGE1"; //$NON-NLS-1$
	public static final String ADD_UTILITY_JAR_WIZARD = J2EEUIPlugin.PLUGIN_ID + ".EAR_ADDUTILITYJARWIZARD_PAGE1"; //$NON-NLS-1$
	//Combine Roles
	...
	public static final String APPCLIENT_EDITOR_OVERVIEW_MESSAGE = J2EEUIPlugin.PLUGIN_ID + ".APPCLIENT_EDITOR_OVERVIEW_MESSAGE"; //$NON-NLS-1$
	...
	public static final String EJB_EDITOR_ASSEMBLY_MES_DEST = J2EEUIPlugin.PLUGIN_ID + ".EJB_EDITOR_ASSEMBLY_MES_DEST"; //$NON-NLS-1$
	...
	public static final String EJB_EDITOR_REFERENCES_MES_DEST_REFERENCE = J2EEUIPlugin.PLUGIN_ID + ".EJB_EDITOR_REFERENCES_MES_DEST_REFERENCE"; //$NON-NLS-1$
	...
	public static final String WEBSERVICE_CILENT_MAIN_SECTION = J2EEUIPlugin.PLUGIN_ID + ".WEBSERVICE_CILENT_MAIN_SECTION"; //$NON-NLS-1$
	public static final String WEBSERVICE_CILENT_DETAIL_SECTION = J2EEUIPlugin.PLUGIN_ID + ".WEBSERVICE_CILENT_DETAIL_SECTION"; //$NON-NLS-1$
	public static final String WEBSERVICE_CILENT_ICON_SECTION = J2EEUIPlugin.PLUGIN_ID + ".WEBSERVICE_CILENT_ICON_SECTION"; //$NON-NLS-1$
	public static final String WEBSERVICE_CILENT_IMPL_DETAIL_SECTION = J2EEUIPlugin.PLUGIN_ID + ".WEBSERVICE_CILENT_IMPL_DETAIL_SECTION"; //$NON-NLS-1$
	public static final String WEBSERVICE_CILENT_INIT_PARAM_SECTION = J2EEUIPlugin.PLUGIN_ID + ".WEBSERVICE_CILENT_INIT_PARAM_SECTION"; //$NON-NLS-1$
	public static final String WEBSERVICE_CILENT_SOAP_HEAD_SECTION = J2EEUIPlugin.PLUGIN_ID + ".WEBSERVICE_CILENT_SOAP_HEAD_SECTION"; //$NON-NLS-1$

	// web service client wizards
	public static final String WEBSERVICE_CILENT_INIT_PARAM_WIZARD_P1 = J2EEUIPlugin.PLUGIN_ID + ".WEBSERVICE_CILENT_INIT_PARAM_WIZARD_P1"; //$NON-NLS-1$
	public static final String WEBSERVICE_CILENT_SOAP_WIZARD_P1 = J2EEUIPlugin.PLUGIN_ID + ".WEBSERVICE_CILENT_SOAP_WIZARD_P1"; //$NON-NLS-1$
	public static final String WEBSERVICE_CILENT_HANDLER_WIZARD_P1 = J2EEUIPlugin.PLUGIN_ID + ".WEBSERVICE_CILENT_HANDLER_WIZARD_P1"; //$NON-NLS-1$
