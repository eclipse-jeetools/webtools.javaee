 ...
 * 
 */
public class EnterpriseApplicationImportWizard extends WTPWizard implements IExecutableExtension, IImportWizard {
	 ...
	 * @param model
	 */
	public EnterpriseApplicationImportWizard(EARImportDataModel model) {
		super(model);
		setWindowTitle(J2EEUIMessages.getResourceString("38")); //$NON-NLS-1$
	}
