 ...
 */
public abstract class J2EEComponentFacetCreationWizard extends J2EEArtifactFacetCreationWizard {
	 ...
	 * </p>
	 */
	public J2EEComponentFacetCreationWizard() {
		super();
	}
	 ...
	 *            operation
	 */
	public J2EEComponentFacetCreationWizard(IDataModel model) {
		super(model);
	}
	...
	protected final boolean shouldShowModulesPage() {
		return getDataModel().isPropertySet(IJ2EEFacetInstallDataModelProperties.EAR_PROJECT_NAME) && shouldShowModulesPageForEAR();
	}
