...
public class ApplicationProjectCreationPage extends J2EEProjectCreationPage {
	 ...
	 * @param pageName
	 */
	protected ApplicationProjectCreationPage(EARProjectCreationDataModel model, String pageName) {
	...
	protected void createServerTargetComposite(Composite parent) {
		...
		newServerTargetButton.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent e) {
				J2EEProjectCreationPage.launchNewRuntimeWizard(getShell(), ((EARProjectCreationDataModel) model).getServerTargetDataModel());
			}
		});
