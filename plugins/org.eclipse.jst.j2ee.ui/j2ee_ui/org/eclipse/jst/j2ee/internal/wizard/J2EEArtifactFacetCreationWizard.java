 ...
 */
public abstract class J2EEArtifactFacetCreationWizard extends DataModelWizard implements INewWizard, IExecutableExtension, IPluginContribution {
	 ...
	 * </p>
	 */
	public J2EEArtifactFacetCreationWizard() {
		super();
	}
	 ...
	 */
	public J2EEArtifactFacetCreationWizard(IDataModel model) {
		super(model);
	}
	...
	protected void postPerformFinish() throws InvocationTargetException {
		...
		String projName = getDataModel().getStringProperty(IProjectCreationPropertiesNew.PROJECT_NAME);
