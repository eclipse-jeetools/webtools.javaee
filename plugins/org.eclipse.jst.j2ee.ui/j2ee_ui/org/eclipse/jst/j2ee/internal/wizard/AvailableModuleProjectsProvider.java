...
public class AvailableModuleProjectsProvider implements IStructuredContentProvider, ITableLabelProvider {
	private J2EEApplicationCreationDataModel model;

	public AvailableModuleProjectsProvider(J2EEApplicationCreationDataModel dataModel) {
		super();
		model = dataModel;
	}
	...
	public Object[] getElements(Object inputElement) {
		...
		if (inputElement instanceof IWorkspaceRoot) {
			...
			if (projects.length > 0) {
				int j2eeVersion = model.getIntProperty(J2EEApplicationCreationDataModel.APPLICATION_VERSION);
