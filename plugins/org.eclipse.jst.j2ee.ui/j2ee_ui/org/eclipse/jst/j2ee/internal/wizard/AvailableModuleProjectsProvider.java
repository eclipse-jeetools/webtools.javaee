...
public class AvailableModuleProjectsProvider implements IStructuredContentProvider, ITableLabelProvider {
	private EARProjectCreationDataModel model;

	public AvailableModuleProjectsProvider(EARProjectCreationDataModel dataModel) {
		super();
		model = dataModel;
	}
	...
	public Object[] getElements(Object inputElement) {
		...
		if (inputElement instanceof IWorkspaceRoot) {
			...
			if (projects.length > 0) {
				int j2eeVersion = model.getIntProperty(EARProjectCreationDataModel.EAR_VERSION);
