...
public class AddSessionEjbWizard extends NewEjbWizard {
	 ...
	 * @param model
	 */
	public AddSessionEjbWizard(EnterpriseBeanClassDataModel model) {
		super(model);
	...
	protected WTPOperationDataModel createDefaultModel() {
		...
		initializeEjbNameListener((EnterpriseBeanClassDataModel) model);
	...
	public void doAddPages() {
		...
		addSessionBeanWizardPage = new AddSessionBeanWizardPage((EnterpriseBeanClassDataModel)createDefaultModel(), PAGE_THREE);
