 ...
 *  
 */
public class WebModuleImportWizard extends J2EEModuleImportWizard {
	 ...
	 * @param model
	 */
	public WebModuleImportWizard(WARImportDataModel model) {
		super(model);
	}
	...
	protected void postPerformFinish() {
		J2EEArtifactCreationDataModel projCreationModel = ((WARImportDataModel) model).getJ2eeArtifactCreationDataModel();
		String finalPerspective = null;
		if (projCreationModel != null)
			finalPerspective = projCreationModel.getStringProperty(J2EEArtifactCreationDataModel.FINAL_PERSPECTIVE);
