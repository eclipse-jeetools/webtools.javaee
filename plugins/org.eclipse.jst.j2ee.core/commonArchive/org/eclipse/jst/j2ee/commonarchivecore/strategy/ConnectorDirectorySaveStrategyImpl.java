...
public class ConnectorDirectorySaveStrategyImpl extends SaveStrategyImpl implements SaveStrategy {
	...
	protected SaveStrategy createNestedDirectoryStrategy(Archive anArchive) {
		String uri = org.eclipse.jst.j2ee.commonarchivecore.util.ArchiveUtil.getOSUri(getDirectoryName(), "");//$NON-NLS-1$
	...
	public void save(org.eclipse.jst.j2ee.commonarchivecore.File aFile, InputStream in) throws SaveFailureException {
		...
		if (aFile.isDirectoryEntry())
			...
			try {
				...
				org.eclipse.jst.j2ee.commonarchivecore.util.ArchiveUtil.copy(in, out);
			} catch (IOException iox) {
