...
public class EJBJarFileImpl extends ModuleFileImpl implements EJBJarFile {
	...
	public List getAssociatedFiles(EnterpriseBean ejb) {
		...
		for (int i = 0; i < classNames.size(); i++) {
			...
			if (className == null)
				continue;
			String classUri = org.eclipse.jst.j2ee.commonarchivecore.util.ArchiveUtil.classNameToUri(className);
			String javaUri = org.eclipse.jst.j2ee.commonarchivecore.util.ArchiveUtil.classNameToJavaUri(className);
			try {
