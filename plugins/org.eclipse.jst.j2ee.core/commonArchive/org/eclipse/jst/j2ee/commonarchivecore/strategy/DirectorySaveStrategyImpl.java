...
import org.eclipse.jst.j2ee.commonarchivecore.helpers.ArchiveURIConverterImpl;
...
public class DirectorySaveStrategyImpl extends SaveStrategyImpl implements SaveStrategy {
	...
	protected SaveStrategy createNestedDirectoryStrategy(Archive anArchive) {
		String uri = org.eclipse.jst.j2ee.commonarchivecore.util.ArchiveUtil.getOSUri(getDirectoryName(), anArchive.getURI());
	 ...
	 * @see com.ibm.etools.archive.SaveStrategy
	 */
	public void save(org.eclipse.jst.j2ee.commonarchivecore.helpers.ArchiveManifest aManifest) throws SaveFailureException {
		try {
	 ...
	 * @see com.ibm.etools.archive.impl.SaveStrategyImpl
	 */
	public void save(org.eclipse.jst.j2ee.commonarchivecore.File aFile, InputStream in) throws SaveFailureException {
	...
	protected void setTimestampAfterSaving(org.eclipse.jst.j2ee.commonarchivecore.File aFile) {
	...
	protected void setTimestampAfterSaving(String uri) {
		org.eclipse.jst.j2ee.commonarchivecore.File aFile = null;
		try {
