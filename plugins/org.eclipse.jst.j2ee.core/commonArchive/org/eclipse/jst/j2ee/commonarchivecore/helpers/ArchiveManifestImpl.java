 ...
 */
public class ArchiveManifestImpl extends java.util.jar.Manifest implements org.eclipse.jst.j2ee.commonarchivecore.helpers.ArchiveManifest {
	/**
	...
	public java.lang.String[] getClassPathTokenized() {
		...
		if (classPath == null)
			return new String[0];
		return org.eclipse.jst.j2ee.commonarchivecore.util.ArchiveUtil.getTokens(classPath);
	}
