...
import org.eclipse.jst.j2ee.commonarchivecore.helpers.FileIterator;
...
public interface SaveStrategy extends ArchiveStrategy {
	...
	public void save() throws org.eclipse.jst.j2ee.commonarchivecore.exception.SaveFailureException;

	public void save(ArchiveManifest aManifest) throws org.eclipse.jst.j2ee.commonarchivecore.exception.SaveFailureException;

	public void save(File aFile, FileIterator iterator) throws org.eclipse.jst.j2ee.commonarchivecore.exception.SaveFailureException;

	public void save(File aFile, java.io.InputStream in) throws org.eclipse.jst.j2ee.commonarchivecore.exception.SaveFailureException;

	public void saveMofResource(Resource aResource) throws org.eclipse.jst.j2ee.commonarchivecore.exception.SaveFailureException;
