 ...
 */
public class SessionRemoteInterfaceCU extends EnterpriseBeanRemoteInterfaceCU {
	/**
	 * CMPEntityRemoteInterfaceCU constructor comment.
	 */
	public SessionRemoteInterfaceCU() {
		super();
	}
	...
	protected String getTypeGeneratorName() {
		return IEJBGenConstants.SESSION_REMOTE_INTERFACE;
	}
}