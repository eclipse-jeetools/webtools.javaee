 ...
 */
public class CMPEntityRemoteInterfaceCU extends EntityRemoteInterfaceCU {
	/**
	 * CMPEntityRemoteInterfaceCU constructor comment.
	 */
	public CMPEntityRemoteInterfaceCU() {
		super();
	}
	...
	protected String getTypeGeneratorName() {
		return IEJBGenConstants.CMP_ENTITY_REMOTE_INTERFACE;
	}
}