 ...
 */
public abstract class EntityHomeMethod extends JavaMethodGenerator {
	/**
	 * EntityHomeMethod constructor comment.
	 */
	public EntityHomeMethod() {
		super();
	}
	...
	protected String getReturnType() throws GenerationException {
		return ((Entity) getSourceElement()).getRemoteInterfaceName();
	}
}