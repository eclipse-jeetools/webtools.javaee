...
public class DefaultFeatureValueConverter implements FeatureValueConverter {
	private static final String FAILED_CONVERSION_PATTERN = EJBCodeGenResourceHandler.getString("Failed_to_convert_{0}_to_{_ERROR_"); //$NON-NLS-1$ = "Failed to convert {0} to {1}."
	...
	protected Object convertToBoolean(Object aValue) {
		...
		if (aValue instanceof Boolean)
			return aValue;
		return failedToConvert(aValue, EJBCodeGenResourceHandler.getString("Boolean_UI_")); //$NON-NLS-1$ = "Boolean"
	}
	...
	protected Object convertToByte(Object aValue) {
		...
		if (aValue instanceof Byte)
			return aValue;
		return failedToConvert(aValue, EJBCodeGenResourceHandler.getString("Byte_UI_")); //$NON-NLS-1$ = "Byte"
	}
	...
	protected Object convertToCharacter(Object aValue) {
		...
		if (aValue instanceof Character)
			return aValue;
		return failedToConvert(aValue, EJBCodeGenResourceHandler.getString("Character_UI_")); //$NON-NLS-1$ = "Character"
	}
	...
	protected Object convertToDouble(Object aValue) {
		...
		if (aValue instanceof Double)
			return aValue;
		return failedToConvert(aValue, EJBCodeGenResourceHandler.getString("Double_UI_")); //$NON-NLS-1$ = "Double"
	}
	...
	protected Object convertToEnum(Object aValue, EStructuralFeature aFeature) {
		...
		if (aValue instanceof String)
			...
			return failedToConvert(aValue, EJBCodeGenResourceHandler.getString("Enumeration_UI_")); //$NON-NLS-1$ = "Enumeration"
	...
	protected Object convertToFloat(Object aValue) {
		...
		if (aValue instanceof Float)
			return aValue;
		return failedToConvert(aValue, EJBCodeGenResourceHandler.getString("Float_UI_")); //$NON-NLS-1$ = "Float"
	}
	...
	protected Object convertToInteger(Object aValue) {
		...
		if (aValue instanceof Integer)
			return aValue;
		return failedToConvert(aValue, EJBCodeGenResourceHandler.getString("Integer_UI_")); //$NON-NLS-1$ = "Integer"
	}
	...
	protected Object convertToLong(Object aValue) {
		...
		if (aValue instanceof Long)
			return aValue;
		return failedToConvert(aValue, EJBCodeGenResourceHandler.getString("Long_UI_")); //$NON-NLS-1$ = "Long"
	}
	...
	protected Object convertToMofObject(Object aValue) {
		if (aValue instanceof EObject)
			return aValue;
		return failedToConvert(aValue, EJBCodeGenResourceHandler.getString("MofObject_UI_")); //$NON-NLS-1$ = "MofObject"
	}
	...
	protected Object convertToShort(Object aValue) {
		...
		if (aValue instanceof Short)
			return aValue;
		return failedToConvert(aValue, EJBCodeGenResourceHandler.getString("Short_UI_")); //$NON-NLS-1$ = "Short"
	}
	...
	protected Object convertValue(Object aValue, org.eclipse.emf.ecore.EAttribute anAttribute) {
		Revisit.revisit();
		//We should look at doing something better for Enum checks.
		//Each Enum will have a different classifierId so we cannot test
		//in the old fashion.
