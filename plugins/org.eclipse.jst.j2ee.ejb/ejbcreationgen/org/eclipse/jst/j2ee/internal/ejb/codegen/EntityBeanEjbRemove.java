...
public class EntityBeanEjbRemove extends EntityBeanEjbMethod {
	/**
	 * EntityBeanEjbRemove constructor comment.
	 */
	public EntityBeanEjbRemove() {
		super();
	}
	...
	protected String[] getExceptions() throws GenerationException {
		if (getDeclaringTypeGenerator().isInterface())
			return new String[]{IEJBGenConstants.REMOVE_EXCEPTION_NAME, IEJBGenConstants.REMOTE_EXCEPTION_NAME};
