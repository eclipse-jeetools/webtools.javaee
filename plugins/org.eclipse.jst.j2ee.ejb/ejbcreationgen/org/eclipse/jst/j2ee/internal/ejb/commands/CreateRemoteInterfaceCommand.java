 ...
 */
public class CreateRemoteInterfaceCommand extends EJBClassReferenceCommand {
	/**
	 ...
	 */
	public CreateRemoteInterfaceCommand(IRootCommand parent, JavaClass aJavaClass) {
	 ...
	 *            java.lang.String
	 */
	public CreateRemoteInterfaceCommand(IRootCommand parent, String aJavaClassName, String aPackageName) {
	...
	protected EJBGenerationHelper createCodegenHelper() {
		...
		ejbClassRefHelper.setRemoteHelper();
	...
	protected void executeForMetadataGeneration() throws CommandExecutionFailure {
		...
		if (remote == null) {
			getEjb().setRemoteInterfaceName(getQualifiedName());
			setJavaClass(getEjb().getRemoteInterface());
		} else
			getEjb().setRemoteInterface(remote);
	}
	...
	protected void undoMetadataGeneration() throws CommandExecutionFailure {
		if (getEjb() != null)
			getEjb().setRemoteInterface(getOriginalJavaClass());
