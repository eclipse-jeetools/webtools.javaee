...
public class SessionLocalInterfaceCU extends EnterpriseBeanLocalInterfaceCU {

	/**
	 * Constructor for SessionLocalInterfaceCU.
	 */
	public SessionLocalInterfaceCU() {
		super();
	}
	...
	protected String getTypeGeneratorName() {
		return IEJBGenConstants.SESSION_LOCAL_INTERFACE;
	}
