 ...
 */
public abstract class EnterpriseBeanHomeInterfaceCU extends JavaCompilationUnitGenerator {
	 ...
	 */
	public EnterpriseBeanHomeInterfaceCU() {
		super();
	}
	...
	protected String getName() {
		if (fName == null)
			fName = Signature.getSimpleName(getHomeInterfaceQualifiedName());
		return fName;
	}
	...
	protected String getPackageName() {
		if (fPackageName == null)
			fPackageName = Signature.getQualifier(getHomeInterfaceQualifiedName());
		return fPackageName;
	}
	...
	protected EJBClassReferenceHelper getClientClassReferenceHelper() {
		return ((EnterpriseBeanHelper) getTopLevelHelper()).getHomeHelper();
	}
