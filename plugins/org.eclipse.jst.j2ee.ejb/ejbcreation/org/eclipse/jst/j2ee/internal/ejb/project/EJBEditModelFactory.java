 ...
 * @author mdelder
 */
public class EJBEditModelFactory extends EditModelFactory {
	...
	public EditModel createEditModelForRead(String editModelID, EMFWorkbenchContext context, Map params) {
		return new EJBEditModel(editModelID, context, true, isLoadKnownResourcesAsReadOnly());
	}
	...
	public EditModel createEditModelForWrite(String editModelID, EMFWorkbenchContext context, Map params) {
		return new EJBEditModel(editModelID, context, false, isLoadKnownResourcesAsReadOnly());
	}
