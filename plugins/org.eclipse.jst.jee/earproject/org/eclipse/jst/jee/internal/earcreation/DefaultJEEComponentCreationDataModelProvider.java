 ...
 *******************************************************************************/
package org.eclipse.jst.jee.internal.earcreation;
...
public class DefaultJEEComponentCreationDataModelProvider extends AbstractDataModelProvider implements IDefaultJEEComponentCreationDataModelProperties {
	...
	public DefaultJEEComponentCreationDataModelProvider() {
		super();
	}
...
//	}
	...
	private void setNestedJ2EEVersion(Object j2eeVersion) {
		...
		if (ejbFacetModel != null) {
			String facetVersionString = JEEVersionUtil.convertVersionIntToString(JEEVersionUtil.convertJ2EEVersionIDToEJBVersionID(j2eeVer));
		...
		if (webFacetModel != null) {
			String facetVersionString = JEEVersionUtil.convertVersionIntToString(JEEVersionUtil.convertJ2EEVersionIDToWebVersionID(j2eeVer));
		...
		if (jcaFacetModel != null) {
			String facetVersionString = JEEVersionUtil.convertVersionIntToString(JEEVersionUtil.convertJ2EEVersionIDToConnectorVersionID(j2eeVer));
		...
		if (clientFacetModel != null){
			String facetVersionString = JEEVersionUtil.convertVersionIntToString(j2eeVer);
