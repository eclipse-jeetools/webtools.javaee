...
public class WebComponentCreationOp extends J2EEComponentCreationOp implements IWebComponentCreationDataModelProperties{

    public WebComponentCreationOp(IDataModel model) {
        super(model);
