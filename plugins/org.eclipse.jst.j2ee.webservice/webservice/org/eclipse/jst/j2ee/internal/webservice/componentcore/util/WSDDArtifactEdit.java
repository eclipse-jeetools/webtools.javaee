...
public class WSDDArtifactEdit extends EnterpriseArtifactEdit {
	 ...
	 */ 
	public WSDDArtifactEdit(ModuleCoreNature aNature, WorkbenchComponent aModule, boolean toAccessAsReadOnly) {
	 ...
	 */
	public static WSDDArtifactEdit getWSDDArtifactEditForRead(WorkbenchComponent aModule) {
	 ...
	 *         underlying content model
	 */
	public static WSDDArtifactEdit getWSDDArtifactEditForWrite(WorkbenchComponent aModule) {
