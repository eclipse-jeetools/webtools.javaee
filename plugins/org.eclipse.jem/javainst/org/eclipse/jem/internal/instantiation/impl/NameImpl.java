 ...
 * <ul>
 *   <li>{@link org.eclipse.jem.internal.instantiation.impl.NameImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NameImpl extends ExpressionImpl implements Name {
	...
	protected EClass eStaticClass() {
		return InstantiationPackage.eINSTANCE.getName_();
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InstantiationPackage.NAME__NAME, oldName, name));
	}
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			case InstantiationPackage.NAME__NAME:
				return getName();
		}
