 ...
 * <!-- end-model-doc -->
 * @see org.eclipse.jem.internal.instantiation.InstantiationPackage#getInfixOperator()
 * @model
 * @generated
 */
public final class InfixOperator extends AbstractEnumerator {
	/**
	 ...
	 * @ordered
	 */
	public static final InfixOperator TIMES_LITERAL = new InfixOperator(TIMES, "TIMES");
	 ...
	 * @ordered
	 */
	public static final InfixOperator DIVIDE_LITERAL = new InfixOperator(DIVIDE, "DIVIDE");
	 ...
	 * @ordered
	 */
	public static final InfixOperator REMAINDER_LITERAL = new InfixOperator(REMAINDER, "REMAINDER");
	 ...
	 * @ordered
	 */
	public static final InfixOperator PLUS_LITERAL = new InfixOperator(PLUS, "PLUS");
	 ...
	 * @ordered
	 */
	public static final InfixOperator MINUS_LITERAL = new InfixOperator(MINUS, "MINUS");
	 ...
	 * @ordered
	 */
	public static final InfixOperator LEFT_SHIFT_LITERAL = new InfixOperator(LEFT_SHIFT, "LEFT_SHIFT");
	 ...
	 * @ordered
	 */
	public static final InfixOperator RIGHT_SHIFT_SIGNED_LITERAL = new InfixOperator(RIGHT_SHIFT_SIGNED, "RIGHT_SHIFT_SIGNED");
	 ...
	 * @ordered
	 */
	public static final InfixOperator RIGHT_SHIFT_UNSIGNED_LITERAL = new InfixOperator(RIGHT_SHIFT_UNSIGNED, "RIGHT_SHIFT_UNSIGNED");
	 ...
	 * @ordered
	 */
	public static final InfixOperator LESS_LITERAL = new InfixOperator(LESS, "LESS");
	 ...
	 * @ordered
	 */
	public static final InfixOperator GREATER_LITERAL = new InfixOperator(GREATER, "GREATER");
	 ...
	 * @ordered
	 */
	public static final InfixOperator LESS_EQUALS_LITERAL = new InfixOperator(LESS_EQUALS, "LESS_EQUALS");
	 ...
	 * @ordered
	 */
	public static final InfixOperator GREATER_EQUALS_LITERAL = new InfixOperator(GREATER_EQUALS, "GREATER_EQUALS");
	 ...
	 * @ordered
	 */
	public static final InfixOperator EQUALS_LITERAL = new InfixOperator(EQUALS, "EQUALS");
	 ...
	 * @ordered
	 */
	public static final InfixOperator NOT_EQUALS_LITERAL = new InfixOperator(NOT_EQUALS, "NOT_EQUALS");
	 ...
	 * @ordered
	 */
	public static final InfixOperator XOR_LITERAL = new InfixOperator(XOR, "XOR");
	 ...
	 * @ordered
	 */
	public static final InfixOperator AND_LITERAL = new InfixOperator(AND, "AND");
	 ...
	 * @ordered
	 */
	public static final InfixOperator OR_LITERAL = new InfixOperator(OR, "OR");
	 ...
	 * @ordered
	 */
	public static final InfixOperator CONDITIONAL_ADD_LITERAL = new InfixOperator(CONDITIONAL_ADD, "CONDITIONAL_ADD");
	 ...
	 * @ordered
	 */
	public static final InfixOperator CONDITIONAL_OR_LITERAL = new InfixOperator(CONDITIONAL_OR, "CONDITIONAL_OR");

	/**
	 * An array of all the '<em><b>Infix Operator</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final InfixOperator[] VALUES_ARRAY =
		new InfixOperator[] {
			TIMES_LITERAL,
			DIVIDE_LITERAL,
			REMAINDER_LITERAL,
	...
	/**
	 * A public read-only list of all the '<em><b>Infix Operator</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * Returns the '<em><b>Infix Operator</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static InfixOperator get(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			InfixOperator result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Infix Operator</b></em>' literal with the specified value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
