...
public final class J2EEApplicationCreationDataModel extends J2EEArtifactCreationDataModel {
	/**
	 * type Integer
	 */
	...
	/**
	 * Creates an Application project with the specified name and version in the specified location.
	 * 
	 * @param projectName
	 *            The name of the Application project to create.
	...
	public static void createProject(String projectName, IPath projectLocation, int j2eeVersion) {
		J2EEApplicationCreationDataModel dataModel = new J2EEApplicationCreationDataModel();
		dataModel.setProperty(J2EEApplicationCreationDataModel.PROJECT_NAME, projectName);
		if (null != projectLocation) {
			dataModel.setProperty(J2EEApplicationCreationDataModel.PROJECT_LOCATION, projectLocation.toOSString());
		}
		dataModel.setIntProperty(J2EEApplicationCreationDataModel.APPLICATION_VERSION, j2eeVersion);
		try {
	...
	public WTPOperation getDefaultOperation() {
		return new J2EEApplicationCreationOperation(this);
	}
