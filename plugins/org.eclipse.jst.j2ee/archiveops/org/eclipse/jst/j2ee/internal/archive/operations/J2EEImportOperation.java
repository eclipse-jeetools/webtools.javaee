...
public abstract class J2EEImportOperation extends WTPOperation {
	...
	protected void doExecute(IProgressMonitor monitor) throws CoreException, InvocationTargetException, InterruptedException {
		J2EEImportDataModel model = (J2EEImportDataModel) operationDataModel;
	...
	protected void importModuleFile(IProgressMonitor monitor) throws InvocationTargetException, InterruptedException {
		J2EEImportDataModel model = (J2EEImportDataModel) operationDataModel;
		ModuleFile moduleFile = ((J2EEImportDataModel) operationDataModel).getModuleFile();
		try {
			monitor.worked(1);
			...
			aStrategy.setIsBinary(model.getBooleanProperty(J2EEImportDataModel.PRESERVE_PROJECT_METADATA));
			aStrategy.setOverwriteHandler((IOverwriteHandler) model.getProperty(J2EEImportDataModel.OVERWRITE_HANDLER));
	...
	protected static void addToClasspath(J2EEImportDataModel importModel, List extraEntries) throws JavaModelException {
