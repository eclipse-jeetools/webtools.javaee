...
public class J2EEComponentClasspathContainer implements IClasspathContainer {
	...
	private boolean requiresUpdate() {
		...
		IVirtualReference[] refs = component instanceof J2EEModuleVirtualComponent ? ((J2EEModuleVirtualComponent)component).getReferences(true): component.getReferences();
