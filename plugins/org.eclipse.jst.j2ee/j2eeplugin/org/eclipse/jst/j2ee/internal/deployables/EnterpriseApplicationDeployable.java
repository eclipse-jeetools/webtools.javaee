...
public class EnterpriseApplicationDeployable extends J2EEDeployable implements IEnterpriseApplication, ILooseArchiveSupport {
    ...
    protected static ModuleFactoryDelegate getModuleFactory(J2EENature nature) {
         ...
         * while (factories.hasNext()) { ModuleFactory deployableFactory =
         * (ModuleFactory) factories.next(); if
         ...
         * instanceof J2EEDeployableFactory) { J2EEDeployableFactory fac =
    ...
    protected static LooseArchiveDeployableFactory getLooseArchiveDeployableFactory() {
         ...
         * ModuleFactoryDelegate deployableFactoryDelegate =
         * deployableFactory.getDelegate(); if (deployableFactoryDelegate
         * instanceof LooseArchiveDeployableFactory) return
