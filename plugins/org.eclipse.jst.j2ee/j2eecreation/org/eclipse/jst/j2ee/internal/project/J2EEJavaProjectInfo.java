...
public class J2EEJavaProjectInfo extends JavaProjectInfo {
	...
	public boolean addJdkJarToClasspathEntries(String jdkJarFullPathName) {
		...
		if (!path.toFile().exists()) {
			org.eclipse.jem.util.logger.proxy.Logger.getLogger().logError(J2EECreationResourceHandler.getString(J2EECreationResourceHandler.JdkJarFileDoesNotExist_UI, new Object[]{jdkJarFullPathName})); //$NON-NLS-1$
			return false;
		}
