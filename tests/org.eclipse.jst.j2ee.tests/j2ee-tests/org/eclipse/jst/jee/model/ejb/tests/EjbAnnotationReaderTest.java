 ...
 * into with SAP.
 * 
 * $Id: EjbAnnotationReaderTest.java,v 1.1 2008/03/11 15:54:48 kraev Exp $
 ***********************************************************************/
...
public class EjbAnnotationReaderTest extends AbstractAnnotationModelTest {
	...
	public static void setUpProject() throws Exception {
		facetedProject = AbstractTest.createProject(EjbAnnotationReaderTest.class.getSimpleName());
	...
	private static void createInvalidCompilationUnit(IPackageFragment fragment) throws Exception {
		...
		IFile file = ((IContainer) fragment.getResource()).getFile(new Path("InvalidSessionBean.java"));
		AbstractTest.saveFile(file, content);
	}

	private static void createMessageDrivenBean(IPackageFragment fragment) throws Exception {
		final String content = "package com.sap;" + "import javax.ejb.MessageDrive;"
		...
		AbstractTest.saveFile(file, content);
		// fragment.createCompilationUnit("MessageDrivenBean.java", "package
		// com.sap;" + "import javax.ejb.MessageDrive;"
		// + "@MessageDriven public class MessageDrivenBean {}", true, null);
	}
	...
	public void testEventsNumber1() throws Exception {
		...
		assertEquals(new Integer(1), listener.getReceivedEvents().size());
	}
	...
	public void testRemoveMethod() throws Exception {
		...
		assertEquals(new Integer(2), result.getRemoveMethods().size());
	...
	public void testInitMetod() throws Exception {
		...
		assertNotNull(method2);
		assertEquals(new Integer(1), method2.getBeanMethod().getMethodParams().getMethodParams().size());
		assertEquals("String", method2.getBeanMethod().getMethodParams().getMethodParams().get(0));
		assertEquals(new Integer(2), result.getInitMethods().size());
	...
	public void testInitMetodStateless() throws Exception {
		...
		assertNotNull(result);
		assertEquals(new Integer(0), result.getInitMethods().size());
	...
	public void testActivationConfigProperty() throws Exception {
		...
		assertEquals(new Integer(2), result.getActivationConfig().getActivationConfigProperties().size());
