...
public class J2EEFlexibleProjectCreationOperationTest extends OperationTestCase {
	 ...
	 * @param dataModel
	 */
	public void setServerTargetProperty(J2EEProjectCreationDataModel dataModel) {
		dataModel.setProperty(J2EEProjectCreationDataModel.SERVER_TARGET_ID, AllTests.JONAS_TOMCAT_RUNTIME.getId());
	}
